...
%                     ["Pindado \& Cubas num\'erico"])
                plot(V_mess, I_Ksol, '-', 'LineWidth', 1.5, 'Color', [0, 0.4470, 0.7410],'DisplayName', ...
                    ["Karmalkar \& Haneefa num\'erico"])
                plot(V_mess, I_Dsol, '-', 'LineWidth', 1.5, 'Color', [0.8500, 0.3250, 0.0980],'DisplayName', ...
                    ["Das num\'erico"])
                plot(V_mess, I_PCsol, '-', 'LineWidth', 1.5, 'Color', [0.4660, 0.6740, 0.1880],'DisplayName', ...
                    ["Pindado \& Cubas num\'erico"])
                axis([0, V_mess(end)*1.1, 0, I_mess(1)*1.1])
                box on; grid on
                legend('Interpreter', 'Latex', 'location', 'SouthWest')
...
%                     ["Pindado \& Cubas num\'erico"])
                plot(V_mess, I_Ksol - I_mess, '-', 'LineWidth', 2, 'Color', [0, 0.4470, 0.7410],'DisplayName', ...
                    ["Karmalkar \& Haneefa num\'erico"])
                plot(V_mess, I_Dsol - I_mess, '-', 'LineWidth', 2, 'Color', [0.8500, 0.3250, 0.0980],'DisplayName', ...
                    ["Das num\'erico"])
                plot(V_mess, (I_PCsol - I_mess')', '-', 'LineWidth', 2, 'Color', [0.4660, 0.6740, 0.1880],'DisplayName', ...
                    ["Pindado \& Cubas num\'erico"])
                axis([0, V_mess(end), min(min([I_Ksol - I_mess, I_Dsol - I_mess, (I_PCsol - I_mess')'])), max(max([I_Ksol - I_mess, I_Dsol - I_mess, (I_PCsol - I_mess')']))])
                box on; grid on
                legend('Interpreter', 'Latex', 'location', 'SouthWest')
                xlabel('$V$ [V]','Interpreter','latex');
...
%%
RMSE = [En_K(:,end), En_D(:,end), En_PC(:,end)];
modelos = {'Karmalkar $\&$ Haneefa', 'Das', 'Pindado $\&$ Cubas'};
